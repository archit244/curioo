...
export default function TestimonialsSection() {
    ...
    const cardSizeRef = useRef(window.innerWidth < 640 ? 280 : 380);
    const [, forceUpdate] = useState(0);

    useEffect(() => {
        const onResize = () => {
            cardSizeRef.current = window.innerWidth < 640 ? 280 : 380;
            forceUpdate(n => n + 1);
        };
    ...
    return (
        <section
            ...
            className="relative w-screen h-screen flex flex-col items-center justify-center overflow-hidden z-10"
            style={{ background: '#000000', perspective: '1000px' }}
        >
            {/* Header */}
            <div className="absolute top-12 text-center z-[60] pointer-events-none">
                <h2
                ...
                <div className="h-[3px] w-[60px] bg-white mx-auto mb-2" />
                <p
                    ...
                    return (
                        <div
                            ...
                            style={{
                                ...
                                background: isCenter ? '#ffffff' : 'rgba(255,255,255,0.06)',
                                color: isCenter ? '#000000' : 'rgba(255,255,255,0.75)',
                                border: isCenter ? '2px solid #ffffff' : '1px solid rgba(255,255,255,0.18)',
                                boxShadow: isCenter ? '20px 20px 0px 0px rgba(0,0,0,0.18)' : 'none',
            ...
            <div className="absolute bottom-12 flex gap-6 z-[60]">
                {[
                    ...
                    <button
                        ...
                        className="flex items-center justify-center w-16 h-16 bg-transparent text-white cursor-pointer transition-all duration-300"
                        style={{
